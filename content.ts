...
// ---------- SERVICE PHOTOS (scrollable strips in the Leadership & Service section) ----------
// One strip per group. Photos live in /public/service. size: "wide" (landscape), "tall" (portrait), or "" (medium).
export const serviceGroups = [
  {
    org: "Project Renaissance",
    note: "Community service and member events",
    photos: [
  ...
  {
    org: "ACM · NC A&T",
    note: "Events I helped plan and program",
    photos: [
      { src: "/service/04-acm-portfolio-night.jpg", alt: "Flyer for ACM Portfolio Night at NC A&T", caption: "Portfolio Night", size: "tall" },
      { src: "/service/05-acm-pitch-in-20.jpg", alt: "Flyer for ACM Pitch in 20 at NC A&T", caption: "Pitch in 20", size: "tall" },
    ],
  },
];
